...
!function(t, e) {
        ...
        fn: function(t) {
            ...
            if (!e.modifiersData[n]._skip) {
                for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, h = i.boundary, d = i.rootBoundary, u = i.altBoundary, f = i.flipVariations, p = void 0 === f || f, g = i.allowedAutoPlacements, m = e.options.placement, _ = Vt(m), b = l || (_ !== m && p ? function(t) {
                    ...
                    return t.concat(Vt(i) === vt ? function(t, e) {
                        void 0 === e && (e = {});
                        var i = e
                          , n = i.placement
                          , s = i.boundary
    ...
    var ze = Fe()
      , qe = Fe({
        defaultModifiers: [me, je, pe, Rt]
    })
      , Re = Fe({
        defaultModifiers: [me, je, pe, Rt, Pe, De, Me, he, Ne]
    });
    ...
    class ci extends z {
        constructor(t, e) {
            ...
            this._menu = Q.next(this._element, ti)[0] || Q.prev(this._element, ti)[0] || Q.findOne(ti, this._parent),
        ...
        static dataApiKeydownHandler(t) {
            ...
            if (e && !i)
                return;
            t.preventDefault();
            const s = this.matches(Je) ? this : Q.prev(this, Je)[0] || Q.next(this, Je)[0] || Q.findOne(Je, t.delegateTarget.parentNode)
    ...
    class vi extends F {
        ...
        dispose() {
            this._isAppended && (P.off(this._element, mi),
            this._element.remove(),
            this._isAppended = !1)
        }
        _getElement() {
    ...
    class Ii extends z {
        ...
        show(t) {
            this._isShown || this._isTransitioning || P.trigger(this._element, Oi, {
                relatedTarget: t
    ...
    const zi = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
      ...
      , Vi = (t,e)=>{
        ...
        return e.includes(i) ? !zi.has(i) || Boolean(qi.test(t.nodeValue) || Ri.test(t.nodeValue)) : e.filter((t=>t instanceof RegExp)).some((t=>t.test(i)))
    }
      , Ki = {
